...
if(isset($_POST['submit'])){
  ...
  $resulttarget="images/".basename($product_image);
    $ProductID=$_GET['id'];
    $result2=$conn->query("UPDATE `product` SET `product_name`='$product_name',`product_price`='$product_price',`Product_des`='$product_price',`CategoryID`='$cat' WHERE product_id ='$ProductID'");

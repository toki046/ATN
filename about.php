	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="Admin/add_product.html">Quản lí</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="about.html">GIới thiệu</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="Admin/Code_sale.html">Mã giảm giá</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="Admin/history.html">Lịch sử</a>
				</li>
			</ul>
		</div>
	</div>
...
<div id="slides" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="./images/bannn.jpg" height="500px">
		</div>
		<div class="carousel-item">
			<img src="./images/logo8.jpg" height="500px">
		</div>
		<div class="carousel-item">
			<img src="./images/bannn.jpg " height="500px">
		</div>
		<div class="carousel-item">
			<img src="./images/logo7.jpg" height="500px">
		</div>
	</div>
</div>
<!-- jumbotron -->
...
<div class="container-fluid padding">
	<div class="row welcome text-center">
		<div class="col-12">
			<h1 class="display-4">Welcome to MOKI SHOP</h1>
		</div>
		<!-- Horizontal Rule -->
		<hr> 
		<div class="col-12">
...
<div class="container-fluid padding">
	<div class="row text-center padding">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<img src="images/logo11.jpg" height="350px">			
			<h3>350.000VNĐ</h3>
			<p>Đã bán 3500sp</p>
		</div>
		<div class="col-sm-12 col-md-4">
			<img src="images/logo14.jpg" height="350px" >			
			<h3>400.000VNĐ</h3>
			<p>Đã bán 3800sp</p>
		</div>
	</div>	
...
<?php $connect = mysqli_connect('localhost','root','','mywebsite');
					...
					while($row_pro = mysqli_fetch_array($result)){
                        ...
                        <img src='$product_image' height='300px' width='250px'>
                        
						</a>
                        <div>$product_name<br>$product_price</div>
                        </div>
						</div>
						</div>
						</div>
